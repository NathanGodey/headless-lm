...
class GPTNeoXAttention(nn.Module):
    ...
    def forward(
        ...
        # Compute attention
        attn_output = self._attn(query.permute(0, 2, 1, 3), key.permute(0, 2, 1, 3), value.permute(0, 2, 1, 3).float(), attention_mask, head_mask)
    ...
    def _attn(self, query, key, value, attention_mask=None, head_mask=None):
        ...
        attn_output = memory_efficient_attention(query, key, value, self.bias, 1./self.norm_factor)
        return attn_output
