...
class XLMRobertaSelfAttention(nn.Module):
    def __init__(self, config, position_embedding_type=None):
        ...
        self.dropout_value = config.attention_probs_dropout_prob
    ...
    def forward(
        ...
        # bias = bias.to(dtype=query_layer.dtype).permute(0, 1, 3, 2)
        
        context_layer = memory_efficient_attention(
            query_layer, key_layer, value_layer, None, self.dropout_value, 1. / math.sqrt(self.attention_head_size)
        )
